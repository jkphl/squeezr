(function (w) {
    if (navigator.cookieEnabled) {
         ...
         */
        function measureWindowEmWidth(precision) {
...
//			console.log(iteration + ' iterations: ' + iterations.join(', '));
        ...
        function getDevicePixelRatio() {
            return roundToPrecision(('devicePixelRatio' in w) ? w.devicePixelRatio : ((('deviceXDPI' in w) && ('logicalXDPI' in w)) ? (w.deviceXDPI / w.logicalXDPI) : 1), 4);
        }

        /**
         * Round a floating point value to a certain precision
         *
         * @param {Number} v Floating point value
         * @param {Number} precision Precision
         * @return {Number} Rounded floating point value
         */
            ...
            if (scripts[index].id == squeezr) {
                ...
                if (!scripts[index].getAttribute('data-disable-images')) {
                    ...
                    do {
                        ...
                        imgBreakpoint = Math.round(nextBreakpoint * pixelRatio) + 'px';
